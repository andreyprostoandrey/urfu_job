...
<body>
    ...
    <form action="src/register.php" method="POST">
        <label for="username">Имя пользователя:
            <input type="text" id="username" name="username" <?php validation_error_attr('username');?>>
        ...
        <label for="email">Email:
            <input type="email" id="email" name="email" <?php validation_error_attr('email');?>>
        ...
        <label for="password">Пароль:
            <input type="password" id="password" name="password" <?php validation_error_attr('password');?>>
